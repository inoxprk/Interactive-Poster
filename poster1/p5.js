...
function setup(){
  createCanvas(windowWidth, windowHeight*3) //html 사이즈만큼 캔버스 생성
}
...
function draw(){
  ...
  // const imgXcrd = (windowWidth-(windowWidth*(imgWidth/550.8)))*scrollPosition/bodyHeight
  // const imgPctToWd = windowWidth*(imgWidth/550.8)
